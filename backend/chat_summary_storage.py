...
class AzureChatSummaryStorage:
    ...
    def save_summary(self, session_id: str, summary: str, merge: bool = True):
        ...
        if merge:
            ...
            try:
                existing = table_client.get_entity('summary', session_id)
    ...
    def get_summary(self, session_id: str) -> dict:
        ...
        try:
            entity = table_client.get_entity('summary', session_id)
    ...
    def delete_summary(self, session_id: str):
        ...
        try:
            table_client.delete_entity('summary', session_id)
        except Exception:
            pass